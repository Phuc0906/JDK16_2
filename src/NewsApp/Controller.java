...
public class Controller {
    ...
    String demoNewspaper = "grwhawerbeabdcvbeiaufbeibveiyuffkehfuidgfiegfSDBFUEGFUIEF";
    ...
    @FXML
    public VBox impNews;
    public void clickImportantNews(MouseEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FXMLFile/ImportantNewsPage.fxml"));
        Parent root = loader.load();

        Stage stage = (Stage) impNews.getScene().getWindow();
        stage.setScene(new Scene(root));
        stage.setTitle("Hello");
        stage.show();
    }
